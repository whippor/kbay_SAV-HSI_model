...
### output directories
#### submodel directory
dir.create("data/c_submodel_data/canopy_fetch_HSI")
submodel_dir <- "data/c_submodel_data/canopy_fetch_HSI"
...
# load data
fetch <- terra::rast("data/b_intermediate_data/canopy_fetch/fetch.grd")
fetch <- fetch/1000

tam_fetch <- read_csv("data/x_tam_tables/canopy/canopy_fetch.csv")
tam_fetch <- tam_fetch %>%
  arrange(fetch.km)
