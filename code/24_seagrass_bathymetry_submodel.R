########################################
### 24. Seagrass Bathymetry submodel ###
########################################
...
### output directories
#### submodel directory
dir.create("data/c_submodel_data/seagrass_bathymetry_HSI")
submodel_dir <- "data/c_submodel_data/seagrass_bathymetry_HSI"
...
# load data
bathymetry <- terra::rast("data/b_intermediate_data/seagrass_bathymetry/bathymetry.grd")

tam_bath <- read_csv("data/x_tam_tables/seagrass/seagrass_depth.csv")
tam_bath <- tam_bath %>%
  arrange(depth.m)
