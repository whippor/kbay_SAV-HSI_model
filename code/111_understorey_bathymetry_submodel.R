############################################
### 111. Understorey Bathymetry submodel ###
############################################
...
### output directories
#### submodel directory
dir.create("data/c_submodel_data/understorey_bathymetry_HSI")
submodel_dir <- "data/c_submodel_data/understorey_bathymetry_HSI"
