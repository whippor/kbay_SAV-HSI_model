###########################################
### 06_x1 Understorey Velocity submodel ###
###########################################
...
### output directories
#### submodel directory
dir.create("data/c_submodel_data/understorey_velocity_HSI")
submodel_dir <- "data/c_submodel_data/understorey_velocity_HSI"
...
# load data
velocity <- terra::rast("data/b_intermediate_data/understorey_velocity/velocity.grd")
