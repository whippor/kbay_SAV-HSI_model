...
### output directories
#### submodel directory
dir.create("data/c_submodel_data/understorey_fetch_HSI")
submodel_dir <- "data/c_submodel_data/understorey_fetch_HSI"
...
# load data
fetch <- terra::rast("data/b_intermediate_data/understorey_fetch/fetch.grd")
fetch <- fetch/1000
